...
function Sidebar() {
    ...
    return (
        ...
        <aside className="w-64 fixed z-10 top-0 bottom-0 h-auto" aria-label="Sidebar">
            
            <div className="overflow-y-auto py-4 px-3 pt-20 bg-gray-50 rounded dark:bg-gray-800">
